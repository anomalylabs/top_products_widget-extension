...
!function (t) {
    ...
    return function e(t, n, i) {
        ...
        1: [function (t, e, n) {
            function i(t) {
                if (t) {
                    var e = /^#([a-fA-F0-9]{3})$/, n = /^#([a-fA-F0-9]{6})$/, i = /^rgba?\(\s*([+-]?\d+)\s*,\s*([+-]?\d+)\s*,\s*([+-]?\d+)\s*(?:,\s*([+-]?[\d\.]+)\s*)?\)$/, a = /^rgba?\(\s*([+-]?[\d\.]+)\%\s*,\s*([+-]?[\d\.]+)\%\s*,\s*([+-]?[\d\.]+)\%\s*(?:,\s*([+-]?[\d\.]+)\s*)?\)$/, r = /(\w+)/, o = [0, 0, 0], s = 1, l = t.match(e);
                    if (l) {
                        l = l[1];
            ...
            function a(t) {
                if (t) {
                    ...
                    if (n) {
                        var i = parseFloat(n[4]), a = b(parseInt(n[1]), 0, 360), r = b(parseFloat(n[2]), 0, 100), o = b(parseFloat(n[3]), 0, 100), s = b(isNaN(i) ? 1 : i, 0, 1);
                        return [a, r, o, s]
                    }
                }
            }
            ...
            !function (e, a) {
                ...
                function h(t) {
                    if (null == t._isValid) {
                        var e = c(t), n = ui.call(e.parsedDateParts, function (t) {
                            return null != t
                        });
                ...
                function E(t, e) {
                    var n;
                    if ("object" == typeof t)for (n in t)this.set(n, t[n]); else if (t = Y(t), S(this[t]))return this[t](e);
                    return this
                }
                ...
                function ot(t, e, n) {
                    ...
                    if (!this._monthsParse)for (this._monthsParse = [], this._longMonthsParse = [], this._shortMonthsParse = [], i = 0; 12 > i; ++i)r = u([2e3, i]), this._shortMonthsParse[i] = this.monthsShort(r, "").toLocaleLowerCase(), this._longMonthsParse[i] = this.months(r, "").toLocaleLowerCase();
                ...
                function pt(t) {
                    var e, n, i, a, r, o, s = t._i, l = ea.exec(s) || na.exec(s);
                    if (l) {
                        for (c(t).iso = !0, e = 0, n = aa.length; n > e; e++)if (aa[e][1].exec(l[1])) {
                            a = aa[e][0], i = aa[e][2] !== !1;
                            break
                        }
                        if (null == a)return void(t._isValid = !1);
                        if (l[3]) {
                            for (e = 0, n = ra.length; n > e; e++)if (ra[e][1].exec(l[3])) {
                                r = (l[2] || " ") + ra[e][0];
                                break
                            }
                ...
                function _t(t, e, n) {
                    var i = 7 + e - n, a = (7 + bt(t, 0, i).getUTCDay() - e) % 7;
                    return -a + i - 1
                }
                ...
                function Wt(t) {
                    var e = t._i, n = t._f;
                    return t._locale = t._locale || W(t._l), null === e || void 0 === n && "" === e ? f({nullInput: !0}) : ("string" == typeof e && (t._i = e = t._locale.preparse(e)), v(e) ? new m(gt(e)) : (a(n) ? It(t) : n ? Ft(t) : r(e) ? t._d = e : Vt(t), h(t) || (t._d = null), t))
                }
                ...
                function Nt(t) {
                    var e = B(t), n = e.year || 0, i = e.quarter || 0, a = e.month || 0, r = e.week || 0, o = e.day || 0, s = e.hour || 0, l = e.minute || 0, u = e.second || 0, d = e.millisecond || 0;
                ...
                function jt(t, e) {
                    var n = (e || "").match(t) || [], i = n[n.length - 1] || [], a = (i + "").match(ca) || ["-", 0, 0], r = +(60 * a[1]) + y(a[2]);
                    return "+" === a[0] ? r : -r
                }
                ...
                function ce(e, n, i, a) {
                    var r = n._milliseconds, o = ue(n._days), s = ue(n._months);
                ...
                function he(t, e) {
                    var n = t || Yt(), i = Gt(n, this).startOf("day"), a = this.diff(i, "days", !0), r = -6 > a ? "sameElse" : -1 > a ? "lastWeek" : 0 > a ? "lastDay" : 1 > a ? "sameDay" : 2 > a ? "nextDay" : 7 > a ? "nextWeek" : "sameElse", o = e && (S(e[r]) ? e[r]() : e[r]);
                ...
                function Je(t, e, n, i, a) {
                    var r = wt(t, e, n, i, a), o = bt(r.year, 0, r.dayOfYear);
                ...
                function ai(t, e, n) {
                    var i = re(t).abs(), a = nr(i.as("s")), r = nr(i.as("m")), o = nr(i.as("h")), s = nr(i.as("d")), l = nr(i.as("M")), u = nr(i.as("y")), d = a < ir.s && ["s", a] || 1 >= r && ["m"] || r < ir.m && ["mm", r] || 1 >= o && ["h"] || o < ir.h && ["hh", o] || 1 >= s && ["d"] || s < ir.d && ["dd", s] || 1 >= l && ["M"] || l < ir.M && ["MM", l] || 1 >= u && ["y"] || ["yy", u];
                ...
                function oi(t) {
                    var e = this.localeData(), n = ai(this, !t, e);
                    return t && (n = e.pastFuture(+this, n)), e.postformat(n)
                }

                function si() {
                    var t, e, n, i = ar(this._milliseconds) / 1e3, a = ar(this._days), r = ar(this._months);
                ...
                var di = t.momentProperties = [], ci = !1, hi = {};
                ...
                var gi, pi, mi = {}, vi = {}, bi = /(\[[^\[]*\])|(\\)?([Hh]mm(ss)?|Mo|MM?M?M?|Do|DDDo|DD?D?D?|ddd?d?|do?|w[o|w]?|W[o|W]?|Qo?|YYYYYY|YYYYY|YYYY|YY|gg(ggg?)?|GG(GGG?)?|e|E|a|A|hh?|HH?|kk?|mm?|ss?|S{1,9}|x|X|zz?|ZZ?|.)/g, yi = /(\[[^\[]*\])|(\\)?(LTS|LT|LL?L?L?|l{1,4})/g, xi = {}, ki = {}, _i = /\d/, wi = /\d\d/, Si = /\d{3}/, Mi = /\d{4}/, Di = /[+-]?\d{6}/, Ci = /\d\d?/, Ti = /\d\d\d\d?/, Pi = /\d\d\d\d\d\d?/, Fi = /\d{1,3}/, Ai = /\d{1,4}/, Ii = /[+-]?\d{1,6}/, Oi = /\d+/, Ri = /[+-]?\d+/, Wi = /Z|[+-]\d\d:?\d\d/gi, Vi = /Z|[+-]\d\d(?::?\d\d)?/gi, Li = /[+-]?\d+(\.\d{1,3})?/, Yi = /[0-9]*['a-z\u00A0-\u05FF\u0700-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF]+|[\u0600-\u06FF\/]+(\s*?[\u0600-\u06FF]+){1,2}/i, Bi = {}, zi = {}, Hi = 0, Ni = 1, Ei = 2, Ui = 3, ji = 4, Gi = 5, qi = 6, Zi = 7, Ji = 8;
                ...
                var ha = /^(\-)?(?:(\d*)[. ])?(\d+)\:(\d+)(?:\:(\d+)\.?(\d{3})?\d*)?$/, fa = /^(-)?P(?:(-?[0-9,.]*)Y)?(?:(-?[0-9,.]*)M)?(?:(-?[0-9,.]*)W)?(?:(-?[0-9,.]*)D)?(?:T(?:(-?[0-9,.]*)H)?(?:(-?[0-9,.]*)M)?(?:(-?[0-9,.]*)S)?)?$/;
                re.fn = Nt.prototype;
                var ga = de(1, "add"), pa = de(-1, "subtract");
                ...
                var ya = "Sunday_Monday_Tuesday_Wednesday_Thursday_Friday_Saturday".split("_"), xa = "Sun_Mon_Tue_Wed_Thu_Fri_Sat".split("_"), ka = "Su_Mo_Tu_We_Th_Fr_Sa".split("_"), _a = Yi, wa = Yi, Sa = Yi;
                ...
                }, Wa = "Invalid date", Va = "%d", La = /\d{1,2}/, Ya = {
                    future: "in %s",
                    past: "%s ago",
                    s: "a few seconds",
                    m: "a minute",
                ...
                var za = Math.abs, Ha = Kn("ms"), Na = Kn("s"), Ea = Kn("m"), Ua = Kn("h"), ja = Kn("d"), Ga = Kn("w"), qa = Kn("M"), Za = Kn("y"), Ja = ei("milliseconds"), Xa = ei("seconds"), Qa = ei("minutes"), $a = ei("hours"), Ka = ei("days"), tr = ei("months"), er = ei("years"), nr = Math.round, ir = {
                    s: 45,
                    m: 45,
                    h: 22,
                    d: 26,
                    M: 11
                }, ar = Math.abs, rr = Nt.prototype;
            ...
            e.exports = function (t) {
                ...
                t.defaults.bar = {
                    ...
                    updateElement: function (t, n, i) {
                        var a = this, r = a.getMeta(), o = a.getScaleForId(r.xAxisID), s = a.getScaleForId(r.yAxisID), l = s.getBasePixel(), u = a.chart.options.elements.rectangle, d = t.custom || {}, c = a.getDataset();
                        e.extend(t, {
                            _xScale: o,
                            _yScale: s,
                    ...
                    calculateBarBase: function (t, e) {
                        var n = this, i = n.getMeta(), a = n.getScaleForId(i.yAxisID), r = 0;
                        if (a.options.stacked) {
                            var o = n.chart, s = o.data.datasets, l = s[t].data[e];
                            if (0 > l)for (var u = 0; t > u; u++) {
                                var d = s[u], c = o.getDatasetMeta(u);
                                c.bar && c.yAxisID === a.id && o.isDatasetVisible(u) && (r += d.data[e] < 0 ? d.data[e] : 0)
                            } else for (var h = 0; t > h; h++) {
                                var f = s[h], g = o.getDatasetMeta(h);
                    ...
                    getRuler: function (t) {
                        var e, n = this, i = n.getMeta(), a = n.getScaleForId(i.xAxisID), r = n.getBarCount();
                        e = "category" === a.options.type ? a.getPixelForTick(t + 1) - a.getPixelForTick(t) : a.width / a.ticks.length;
                        var o = e * a.options.categoryPercentage, s = (e - e * a.options.categoryPercentage) / 2, l = o / r;
                        if (a.ticks.length !== n.chart.data.labels.length) {
                            var u = a.ticks.length / n.chart.data.labels.length;
                            l *= u
                        }
                        var d = l * a.options.barPercentage, c = l - l * a.options.barPercentage;
                        return {
                            datasetCount: r,
                            tickWidth: e,
                            categoryWidth: o,
                    ...
                    calculateBarWidth: function (t) {
                        var e = this.getScaleForId(this.getMeta().xAxisID), n = this.getRuler(t);
                    ...
                    calculateBarX: function (t, e) {
                        var n = this, i = n.getMeta(), a = n.getScaleForId(i.xAxisID), r = n.getBarIndex(e), o = n.getRuler(t), s = a.getPixelForValue(null, t, e, n.chart.isCombo);
                    ...
                    calculateBarY: function (t, e) {
                        var n = this, i = n.getMeta(), a = n.getScaleForId(i.yAxisID), r = n.getDataset().data[t];
                        if (a.options.stacked) {
                            for (var o = 0, s = 0, l = 0; e > l; l++) {
                                var u = n.chart.data.datasets[l], d = n.chart.getDatasetMeta(l);
                    ...
                    updateElement: function (t, n, i, a) {
                        var r = this, o = r.getMeta(), s = r.getScaleForId(o.xAxisID), l = r.getScaleForId(o.yAxisID), u = s.getBasePixel(), d = t.custom || {}, c = r.getDataset(), h = r.chart.options.elements.rectangle;
                        e.extend(t, {
                            _xScale: s,
                            _yScale: l,
                            ...
                            draw: function () {
                                ...
                                var e = this._chart.ctx, n = this._view, i = n.height / 2, a = n.y - i, r = n.y + i, o = n.base - (n.base - n.x), s = n.borderWidth / 2;
                                ...
                                var l = [[n.base, r], [n.base, a], [o, a], [o, r]], u = ["bottom", "left", "top", "right"], d = u.indexOf(n.borderSkipped, 0);
                        ...
                        var n = this, i = n.getMeta(), a = n.getScaleForId(i.xAxisID), r = 0;
                        if (a.options.stacked) {
                            var o = n.chart.data.datasets[t].data[e];
                            if (0 > o)for (var s = 0; t > s; s++) {
                                var l = n.chart.data.datasets[s], u = n.chart.getDatasetMeta(s);
                                u.bar && u.xAxisID === a.id && n.chart.isDatasetVisible(s) && (r += l.data[e] < 0 ? l.data[e] : 0)
                            } else for (var d = 0; t > d; d++) {
                                var c = n.chart.data.datasets[d], h = n.chart.getDatasetMeta(d);
                        ...
                        var e, n = this, i = n.getMeta(), a = n.getScaleForId(i.yAxisID), r = n.getBarCount();
                        e = "category" === a.options.type ? a.getPixelForTick(t + 1) - a.getPixelForTick(t) : a.width / a.ticks.length;
                        var o = e * a.options.categoryPercentage, s = (e - e * a.options.categoryPercentage) / 2, l = o / r;
                        if (a.ticks.length !== n.chart.data.labels.length) {
                            var u = a.ticks.length / n.chart.data.labels.length;
                        ...
                        var e = this, n = e.getScaleForId(e.getMeta().yAxisID), i = e.getRuler(t);
                        return n.options.stacked ? i.categoryHeight : i.barHeight
                    }, calculateBarX: function (t, e) {
                        var n = this, i = n.getMeta(), a = n.getScaleForId(i.xAxisID), r = n.getDataset().data[t];
                        if (a.options.stacked) {
                            for (var o = 0, s = 0, l = 0; e > l; l++) {
                                var u = n.chart.data.datasets[l], d = n.chart.getDatasetMeta(l);
                        ...
                        var n = this, i = n.getMeta(), a = n.getScaleForId(i.yAxisID), r = n.getBarIndex(e), o = n.getRuler(t), s = a.getPixelForValue(null, t, e, n.chart.isCombo);
            ...
            e.exports = function (t) {
                ...
                t.defaults.bubble = {
                    ...
                    updateElement: function (n, i, a) {
                        var r = this, o = r.getMeta(), s = r.getScaleForId(o.xAxisID), l = r.getScaleForId(o.yAxisID), u = n.custom || {}, d = r.getDataset(), c = d.data[i], h = r.chart.options.elements.point, f = r.index;
                        e.extend(n, {
                            _xScale: s,
                            _yScale: l,
                            _datasetIndex: f,
            ...
            e.exports = function (t) {
                ...
                n.doughnut = {
                        ...
                        labels: {
                            generateLabels: function (t) {
                                ...
                                return n.labels.length && n.datasets.length ? n.labels.map(function (i, a) {
                                    var r = t.getDatasetMeta(0), o = n.datasets[0], s = r.data[a], l = s.custom || {}, u = e.getValueAtIndexOrDefault, d = t.options.elements.arc, c = l.backgroundColor ? l.backgroundColor : u(o.backgroundColor, a, d.backgroundColor), h = l.borderColor ? l.borderColor : u(o.borderColor, a, d.borderColor), f = l.borderWidth ? l.borderWidth : u(o.borderWidth, a, d.borderWidth);
                                    return {
                                        text: i,
                                        fillStyle: c,
                                        strokeStyle: h,
                    ...
                    update: function (t) {
                        var n = this, i = n.chart, a = i.chartArea, r = i.options, o = r.elements.arc, s = a.right - a.left - o.borderWidth, l = a.bottom - a.top - o.borderWidth, u = Math.min(s, l), d = {
                            x: 0,
                            y: 0
                        ...
                        if (f < 2 * Math.PI) {
                            ...
                            var p = g + f, m = {x: Math.cos(g), y: Math.sin(g)}, v = {
                                x: Math.cos(p),
                                y: Math.sin(p)
                            }, b = 0 >= g && p >= 0 || g <= 2 * Math.PI && 2 * Math.PI <= p, y = g <= .5 * Math.PI && .5 * Math.PI <= p || g <= 2.5 * Math.PI && 2.5 * Math.PI <= p, x = g <= -Math.PI && -Math.PI <= p || g <= Math.PI && Math.PI <= p, k = g <= .5 * -Math.PI && .5 * -Math.PI <= p || g <= 1.5 * Math.PI && 1.5 * Math.PI <= p, _ = h / 100, w = {
            ...
            e.exports = function (t) {
                ...
                t.defaults.line = {
                    ...
                    addElementAndReset: function (n) {
                        var i = this, a = i.chart.options, r = i.getMeta();
                    ...
                    updateElement: function (t, e, i) {
                        var a, r, o = this, s = o.getMeta(), l = t.custom || {}, u = o.getDataset(), d = o.index, c = u.data[e], h = o.getScaleForId(s.yAxisID), f = o.getScaleForId(s.xAxisID), g = o.chart.options.elements.point;
                    ...
                    calculatePointY: function (t, e, n, i) {
                        var a, r, o, s = this, l = s.chart, u = s.getMeta(), d = s.getScaleForId(u.yAxisID), c = 0, h = 0;
                    ...
                    updateBezierControlPoints: function () {
                        var t, e, i, a, r, o = this.getMeta(), s = (this.chart.chartArea, o.data || []);
                    ...
                    draw: function (t) {
                        var n, i, a = this, r = a.getMeta(), o = r.data || [], s = t || 1;
            ...
            e.exports = function (t) {
                ...
                t.defaults.polarArea = {
                    ...
                    legendCallback: function (t) {
                        ...
                        e.push('<ul class="' + t.id + '-legend">');
                        var n = t.data, i = n.datasets, a = n.labels;
                        if (i.length)for (var r = 0; r < i[0].data.length; ++r)e.push('<li><span style="background-color:' + i[0].backgroundColor[r] + '">'), a[r] && e.push(a[r]), e.push("</span></li>");
                        return e.push("</ul>"), e.join("")
                    },
                    legend: {
                        labels: {
                    ...
                    linkScales: e.noop,
                    update: function (t) {
                        var n = this, i = n.chart, a = i.chartArea, r = n.getMeta(), o = i.options, s = o.elements.arc, l = Math.min(a.right - a.left, a.bottom - a.top);
                    ...
                    updateElement: function (t, n, i) {
                        ...
                        var y = -.5 * Math.PI, x = t.hidden ? 0 : d.getDistanceFromCenterForValue(s.data[n]), k = y + f * m, _ = k + (t.hidden ? 0 : f), w = u.animateScale ? 0 : d.getDistanceFromCenterForValue(s.data[n]);
                        e.extend(t, {
                            _datasetIndex: a.index,
                            _index: n,
                            _scale: d,
            ...
            e.exports = function (t) {
                ...
                t.defaults.radar = {
                    ...
                    update: function (t) {
                        var n = this, i = n.getMeta(), a = i.dataset, r = i.data, o = a.custom || {}, s = n.getDataset(), l = n.chart.options.elements.line, u = n.chart.scale;
                        void 0 !== s.tension && void 0 === s.lineTension && (s.lineTension = s.tension), e.extend(i.dataset, {
                            _datasetIndex: n.index, _children: r, _loop: !0,
                            _model: {
                    ...
                    updateElement: function (t, n, i) {
                        var a = this, r = t.custom || {}, o = a.getDataset(), s = a.chart.scale, l = a.chart.options.elements.point, u = s.getPointPositionForValue(n, o.data[n]);
                        e.extend(t, {
                            _datasetIndex: a.index,
                            _index: n,
                            _scale: s,
            ...
            e.exports = function (t) {
                ...
                t.types = {}, t.instances = {}, t.controllers = {}, t.Controller = function (n) {
                    ...
                    initialize: function () {
                        ...
                        var i = this, a = i.chart, r = a.canvas, o = e.getMaximumWidth(r), s = a.aspectRatio, l = i.options.maintainAspectRatio && isNaN(s) === !1 && isFinite(s) && 0 !== s ? o / s : e.getMaximumHeight(r), u = a.width !== o || a.height !== l;
                        if (!u)return i;
                        r.width = a.width = o, r.height = a.height = l, e.retinaScale(a);
                        var d = {width: o, height: l};
                        ...
                        var n = this, i = n.options, a = n.scales = {}, r = [];
                        i.scales && (r = r.concat((i.scales.xAxes || []).map(function (t) {
                            ...
                            var o = i.options, s = e.getValueOrDefault(o.type, i.dtype), l = t.scaleService.getScaleConstructor(s);
                            if (l) {
                                var u = new l({id: o.id, options: o, ctx: n.chart.ctx, chart: n});
                        ...
                        if (e.each(n.data.datasets, function (e, r) {
                            ...
                            }, n), i.length > 1)for (var r = 1; r < i.length; r++)if (i[r] !== i[r - 1]) {
                            n.isCombo = !0;
                            break
                        }
                        return a
                        ...
                        if (r && ("undefined" != typeof n && 0 !== n || "undefined" == typeof n && 0 !== r.duration)) {
                            ...
                            o.numSteps = (n || r.duration) / 16.66, o.easing = r.easing, o.render = function (t, n) {
                                var i = e.easingEffects[n.easing], a = n.currentStep / n.numSteps, r = i(a);
                        ...
                        var n = this, i = e.getRelativePosition(t, n.chart), a = [], r = function () {
                        ...
                        var n = this, i = n.tooltip, a = n.options || {}, r = a.hover, o = a.tooltips;
            ...
            e.exports = function (t) {
                ...
                t.DatasetController = function (t, e) {
                    ...
                    removeHoverStyle: function (t, n) {
                        var i = this.chart.data.datasets[t._datasetIndex], a = t._index, r = t.custom || {}, o = e.getValueAtIndexOrDefault, s = (e.color, t._model);
                    ...
                    setHoverStyle: function (t) {
                        var n = this.chart.data.datasets[t._datasetIndex], i = t._index, a = t.custom || {}, r = e.getValueAtIndexOrDefault, o = (e.color, e.getHoverColor), s = t._model;
            ...
            e.exports = function (t) {
                ...
                r.each = function (t, e, n, i) {
                    ...
                    return r.each(Array.prototype.slice.call(arguments, 1), function (e) {
                        r.each(e, function (e, i) {
                            if ("scales" === i)n[i] = r.scaleMerge(n.hasOwnProperty(i) ? n[i] : {}, e); else if ("scale" === i)n[i] = r.configMerge(n.hasOwnProperty(i) ? n[i] : {}, t.scaleService.getScaleDefaults(e.type), e); else if (n.hasOwnProperty(i) && r.isArray(n[i]) && r.isArray(e)) {
                                var a = n[i];
                    ...
                    return r.each(n, function (e, n) {
                        "xAxes" === n || "yAxes" === n ? i.hasOwnProperty(n) ? r.each(e, function (e, a) {
                            var o = r.getValueOrDefault(e.type, "xAxes" === n ? "category" : "linear"), s = t.scaleService.getScaleDefaults(o);
                    ...
                    var a = t.skip ? e : t, r = e, o = n.skip ? e : n, s = Math.sqrt(Math.pow(r.x - a.x, 2) + Math.pow(r.y - a.y, 2)), l = Math.sqrt(Math.pow(o.x - r.x, 2) + Math.pow(o.y - r.y, 2)), u = s / (s + l), d = l / (s + l);
                ...
                r.requestAnimFrame = function () {
                    ...
                    var e = t.parentNode, n = parseInt(r.getStyle(e, "padding-left")) + parseInt(r.getStyle(e, "padding-right")), i = e.clientWidth - n, a = r.getConstraintWidth(t);
                    return isNaN(a) ? i : Math.min(i, a)
                }, r.getMaximumHeight = function (t) {
                    var e = t.parentNode, n = parseInt(r.getStyle(e, "padding-top")) + parseInt(r.getStyle(e, "padding-bottom")), i = e.clientHeight - n, a = r.getConstraintHeight(t);
                    return isNaN(a) ? i : Math.min(i, a)
                }, r.getStyle = function (t, e) {
                    return t.currentStyle ? t.currentStyle[e] : document.defaultView.getComputedStyle(t, null).getPropertyValue(e)
                }, r.retinaScale = function (t) {
                    var e = t.ctx, n = t.canvas, i = n.width, a = n.height, r = t.currentDevicePixelRatio = window.devicePixelRatio || 1;
                    ...
                    defaults: {}, addBox: function (t, e) {
                        ...
                        function r(t) {
                            ...
                            if (n)if (t.isHorizontal()) {
                                var i = {left: S, right: M, top: 0, bottom: 0};
                        ...
                        if (t) {
                            var l = 0, u = 0, d = e.where(t.boxes, function (t) {
                            ...
                            var p = n - 2 * l, m = i - 2 * u, v = p / 2, b = m / 2, y = (n - v) / (d.length + c.length), x = (i - b) / (h.length + f.length), k = p, _ = m, w = [];
            ...
            e.exports = function (t) {
                ...
                t.defaults.global.legend = {
                    ...
                    initialize: function (t) {
                        ...
                        var n = this, i = n.options, a = i.labels, r = i.display, o = n.ctx, s = t.defaults.global, l = e.getValueOrDefault, u = l(a.fontSize, s.defaultFontSize), d = l(a.fontStyle, s.defaultFontStyle), c = l(a.fontFamily, s.defaultFontFamily), h = e.fontString(u, d, c), f = n.legendHitBoxes = [], g = n.minSize, p = n.isHorizontal();
                        if (p ? (g.width = n.maxWidth, g.height = r ? 10 : 0) : (g.width = r ? 10 : 0, g.height = n.maxHeight), r)if (o.font = h, p) {
                            var m = n.lineWidths = [0], v = n.legendItems.length ? u + a.padding : 0;
                            ...
                            var b = a.padding, y = n.columnWidths = [], x = a.padding, k = 0, _ = 0, w = u + b;
                        ...
                        var n = this, i = n.options, a = i.labels, r = t.defaults.global, o = r.elements.line, s = n.width, l = (n.height, n.lineWidths);
                        if (i.display) {
                            var u, d = n.ctx, c = e.getValueOrDefault, h = c(a.fontColor, r.defaultFontColor), f = c(a.fontSize, r.defaultFontSize), g = c(a.fontStyle, r.defaultFontStyle), p = c(a.fontFamily, r.defaultFontFamily), m = e.fontString(f, g, p);
                            d.textAlign = "left", d.textBaseline = "top", d.lineWidth = .5, d.strokeStyle = h, d.fillStyle = h, d.font = m;
                            var v = a.boxWidth, b = n.legendHitBoxes, y = function (t, e, n) {
                            ...
                            u = k ? {x: n.left + (s - l[0]) / 2, y: n.top + a.padding, line: 0} : {
                                x: n.left + a.padding,
                                y: n.top,
                                line: 0
                            };
                            var _ = f + a.padding;
                            e.each(n.legendItems, function (t, e) {
                                var i = d.measureText(t.text).width, r = v + f / 2 + i, o = u.x, c = u.y;
                        ...
                        var n = this, i = e.getRelativePosition(t, n.chart.chart), a = i.x, r = i.y, o = n.options;
                        if (a >= n.left && a <= n.right && r >= n.top && r <= n.bottom)for (var s = n.legendHitBoxes, l = 0; l < s.length; ++l) {
                            var u = s[l];
            ...
            e.exports = function (t) {
                ...
                t.plugins = {
                    _plugins: [], register: function (t) {
                        ...
                        var n, i, a = this._plugins, r = a.length;
                        for (n = 0; r > n; ++n)if (i = a[n], "function" == typeof i[t] && i[t].apply(i, e || []) === !1)return !1;
                        return !0
                    }
            ...
            e.exports = function (t) {
                ...
                t.defaults.scale = {
                    ...
                    calculateTickRotation: function () {
                        var n = this, i = n.ctx, a = t.defaults.global, r = n.options.ticks, o = e.getValueOrDefault(r.fontSize, a.defaultFontSize), s = e.getValueOrDefault(r.fontStyle, a.defaultFontStyle), l = e.getValueOrDefault(r.fontFamily, a.defaultFontFamily), u = e.fontString(o, s, l);
                        i.font = u;
                        var d, c = i.measureText(n.ticks[0]).width, h = i.measureText(n.ticks[n.ticks.length - 1]).width;
                    ...
                    fit: function () {
                        var n = this, i = n.minSize = {
                            width: 0,
                            height: 0
                        }, a = n.options, r = t.defaults.global, o = a.ticks, s = a.scaleLabel, l = a.display, u = n.isHorizontal(), d = e.getValueOrDefault(o.fontSize, r.defaultFontSize), c = e.getValueOrDefault(o.fontStyle, r.defaultFontStyle), h = e.getValueOrDefault(o.fontFamily, r.defaultFontFamily), f = e.fontString(d, c, h), g = e.getValueOrDefault(s.fontSize, r.defaultFontSize), p = e.getValueOrDefault(s.fontStyle, r.defaultFontStyle), m = e.getValueOrDefault(s.fontFamily, r.defaultFontFamily), v = (e.fontString(g, p, m), a.gridLines.tickMarkLength);
                        if (u ? i.width = n.isFullWidth() ? n.maxWidth - n.margins.left - n.margins.right : n.maxWidth : i.width = l ? v : 0, u ? i.height = l ? v : 0 : i.height = n.maxHeight, s.display && l && (u ? i.height += 1.5 * g : i.width += 1.5 * g), o.display && l) {
                            ...
                            var b = e.longestText(n.ctx, f, n.ticks, n.longestTextCache), y = e.numberOfLabelLines(n.ticks), x = .5 * d;
                            if (u) {
                                ...
                                var _ = n.ctx.measureText(n.ticks[0]).width, w = n.ctx.measureText(n.ticks[n.ticks.length - 1]).width, S = Math.cos(e.toRadians(n.labelRotation)), M = Math.sin(e.toRadians(n.labelRotation));
                                n.paddingLeft = 0 !== n.labelRotation ? S * _ + 3 : _ / 2 + 3, n.paddingRight = 0 !== n.labelRotation ? M * (d / 2) + 3 : w / 2 + 3
                            } else {
                                var D = n.maxWidth - i.width, C = o.mirror;
                    ...
                    draw: function (n) {
                        ...
                        if (a.display) {
                            var r, o, s = i.ctx, l = t.defaults.global, u = a.ticks, d = a.gridLines, c = a.scaleLabel, h = 0 !== i.labelRotation, f = u.autoSkip, g = i.isHorizontal();
                            u.maxTicksLimit && (o = u.maxTicksLimit);
                            var p = e.getValueOrDefault(u.fontColor, l.defaultFontColor), m = e.getValueOrDefault(u.fontSize, l.defaultFontSize), v = e.getValueOrDefault(u.fontStyle, l.defaultFontStyle), b = e.getValueOrDefault(u.fontFamily, l.defaultFontFamily), y = e.fontString(m, v, b), x = d.tickMarkLength, k = e.getValueOrDefault(c.fontColor, l.defaultFontColor), _ = e.getValueOrDefault(c.fontSize, l.defaultFontSize), w = e.getValueOrDefault(c.fontStyle, l.defaultFontStyle), S = e.getValueOrDefault(c.fontFamily, l.defaultFontFamily), M = e.fontString(_, w, S), D = e.toRadians(i.labelRotation), C = Math.cos(D), T = (Math.sin(D), i.longestLabelWidth * C);
                            s.fillStyle = p;
                            var P = [];
                            if (g) {
                                if (r = !1, h && (T /= 2), (T + u.autoSkipPadding) * i.ticks.length > i.width - (i.paddingLeft + i.paddingRight) && (r = 1 + Math.floor((T + u.autoSkipPadding) * i.ticks.length / (i.width - (i.paddingLeft + i.paddingRight)))), o && i.ticks.length > o)for (; !r || i.ticks.length / (r || 1) > o;)r || (r = 1), r += 1;
                                f || (r = !1)
                            }
                            var F = "right" === a.position ? i.left : i.right - x, A = "right" === a.position ? i.left + x : i.right, I = "bottom" === a.position ? i.top : i.bottom - x, O = "bottom" === a.position ? i.top + x : i.bottom;
                            if (e.each(i.ticks, function (t, o) {
                                    if (void 0 !== t && null !== t) {
                                        var s = i.ticks.length === o + 1, l = r > 1 && o % r > 0 || o % r === 0 && o + r >= i.ticks.length;
                                ...
                                var R, W, V = 0;
                                if (g)R = i.left + (i.right - i.left) / 2, W = "bottom" === a.position ? i.bottom - _ / 2 : i.top + _ / 2; else {
                            ...
                            if (d.drawBorder) {
                                ...
                                var Y = i.left, B = i.right, z = i.top, H = i.bottom, N = e.aliasPixel(s.lineWidth);
            ...
            e.exports = function (t) {
                ...
                t.Title = t.Element.extend({
                    ...
                    beforeFit: n,
                    fit: function () {
                        var n = this, i = (n.ctx, e.getValueOrDefault), a = n.options, r = t.defaults.global, o = a.display, s = i(a.fontSize, r.defaultFontSize), l = n.minSize;
                    ...
                    draw: function () {
                        var n = this, i = n.ctx, a = e.getValueOrDefault, r = n.options, o = t.defaults.global;
                        if (r.display) {
                            var s, l, u = a(r.fontSize, o.defaultFontSize), d = a(r.fontStyle, o.defaultFontStyle), c = a(r.fontFamily, o.defaultFontFamily), h = e.fontString(u, d, c), f = 0, g = n.top, p = n.left, m = n.bottom, v = n.right;
            ...
            e.exports = function (t) {
                ...
                t.defaults.global.tooltips = {
                    ...
                    initialize: function () {
                        var e = this, n = t.defaults.global, i = e._options, r = a.getValueOrDefault;
                        a.extend(e, {
                            _model: {
                                xPadding: i.xPadding,
                                yPadding: i.yPadding,
                        ...
                        var t = this, n = t._options, i = n.callbacks, a = i.beforeTitle.apply(t, arguments), r = i.title.apply(t, arguments), o = i.afterTitle.apply(t, arguments), s = [];
                        ...
                        var t = this, n = t._options.callbacks, i = n.beforeFooter.apply(t, arguments), a = n.footer.apply(t, arguments), r = n.afterFooter.apply(t, arguments), o = [];
                        return o = e(o, i), o = e(o, a), o = e(o, r)
                    }, update: function (t) {
                        var e, r, o = this, s = o._options, l = o._model, u = o._active, d = o._data, c = o._chartInstance;
                        if (u.length) {
                            l.opacity = 1;
                            var h = [], f = n(u), g = [];
                        ...
                        var e = this._chart.ctx, n = {
                            height: 2 * t.yPadding,
                            width: 0
                        }, i = t.body, r = i.reduce(function (t, e) {
                            return t + e.before.length + e.lines.length + e.after.length
                        }, 0);
                        r += t.beforeBody.length + t.afterBody.length;
                        var o = t.title.length, s = t.footer.length, l = t.titleFontSize, u = t.bodyFontSize, d = t.footerFontSize;
                        ...
                        var r, o, s, l, u, d = (a.left + a.right) / 2, c = (a.top + a.bottom) / 2;
                        ...
                        var n = {
                            x: t.x,
                            y: t.y
                        }, i = t.caretSize, a = t.caretPadding, r = t.cornerRadius, o = t.xAlign, s = t.yAlign, l = i + a, u = r + a;
                        ...
                        var r, o, s, l, u, d, c = this._view, h = this._chart.ctx, f = c.caretSize, g = c.cornerRadius, p = c.xAlign, m = c.yAlign, v = t.x, b = t.y, y = e.width, x = e.height;
                        ...
                        if (r.length) {
                            ...
                            var o = e.titleFontSize, s = e.titleSpacing, l = a.color(e.titleFontColor);
                        ...
                        var r = e.bodyFontSize, o = e.bodySpacing, s = e.body;
                        n.textAlign = e._bodyAlign, n.textBaseline = "top";
                        var l = a.color(e.bodyFontColor), u = l.alpha(i * l.alpha()).rgbString();
            ...
            e.exports = function (t, e) {
                var n = t.helpers, i = t.defaults.global;
                i.elements.arc = {
                    ...
                    inLabelRange: function (t) {
                        ...
                        if (i) {
                            ...
                            for (; r > l;)r -= 2 * Math.PI;
                            for (; s > r;)r += 2 * Math.PI;
                            var u = r >= s && l >= r, d = o >= i.innerRadius && o <= i.outerRadius;
                            return u && d
                        }
                        return !1
                    }, tooltipPosition: function () {
            ...
            e.exports = function (t) {
                ...
                t.defaults.global.elements.line = {
                    ...
                    lineToNextPoint: function (t, e, n, i, a) {
                        var r = this, o = r._chart.ctx, s = r._view ? r._view.spanGaps : !1;
                        ...
                        var i = this, a = i._view, r = i._chart.ctx, o = i._children[0], s = i._children[i._children.length - 1];
                        r.save(), i._children.length > 0 && a.fill && (r.beginPath(), e.each(i._children, function (t, n) {
                            var o = e.previousItem(i._children, n), s = e.nextItem(i._children, n);
                        ...
                        r.lineCap = a.borderCapStyle || l.borderCapStyle, r.setLineDash && r.setLineDash(a.borderDash || l.borderDash), r.lineDashOffset = a.borderDashOffset || l.borderDashOffset, r.lineJoin = a.borderJoinStyle || l.borderJoinStyle, r.lineWidth = a.borderWidth || l.borderWidth, r.strokeStyle = a.borderColor || n.defaultColor, r.beginPath(), e.each(i._children, function (t, n) {
                            var a = e.previousItem(i._children, n), o = e.nextItem(i._children, n);
            ...
            e.exports = function (t) {
                ...
                n.elements.point = {
                    ...
                    inRange: function (t, e) {
                        ...
                        var t, a, r, o, s, l, u = this._view, d = this._chart.ctx, c = u.pointStyle, h = u.radius, f = u.x, g = u.y;
                        if (!u.skip) {
                            ...
                            if (!(isNaN(h) || 0 >= h)) {
                                switch (d.strokeStyle = u.borderColor || i, d.lineWidth = e.getValueOrDefault(u.borderWidth, n.elements.point.borderWidth), d.fillStyle = u.backgroundColor || i, c) {
                                    default:
                                        d.beginPath(), d.arc(f, g, h, 0, 2 * Math.PI), d.closePath(), d.fill();
                                        break;
                                    case"triangle":
                                        d.beginPath(), a = 3 * h / Math.sqrt(3), s = a * Math.sqrt(3) / 2, d.moveTo(f - a / 2, g + s / 3), d.lineTo(f + a / 2, g + s / 3), d.lineTo(f, g - 2 * s / 3), d.closePath(), d.fill();
                                        break;
                                    case"rect":
                                        l = 1 / Math.SQRT2 * h, d.fillRect(f - l, g - l, 2 * l, 2 * l), d.strokeRect(f - l, g - l, 2 * l, 2 * l);
                                        break;
                                    case"rectRot":
                                        l = 1 / Math.SQRT2 * h, d.beginPath(), d.moveTo(f - l, g), d.lineTo(f, g + l), d.lineTo(f + l, g), d.lineTo(f, g - l), d.closePath(), d.fill();
                                        break;
                                    case"cross":
                                        d.beginPath(), d.moveTo(f, g + h), d.lineTo(f, g - h), d.moveTo(f - h, g), d.lineTo(f + h, g), d.closePath();
                                        break;
                                    case"crossRot":
                                        d.beginPath(), r = Math.cos(Math.PI / 4) * h, o = Math.sin(Math.PI / 4) * h, d.moveTo(f - r, g - o), d.lineTo(f + r, g + o), d.moveTo(f - r, g + o), d.lineTo(f + r, g - o), d.closePath();
                                        break;
                                    case"star":
                                        d.beginPath(), d.moveTo(f, g + h), d.lineTo(f, g - h), d.moveTo(f - h, g), d.lineTo(f + h, g), r = Math.cos(Math.PI / 4) * h, o = Math.sin(Math.PI / 4) * h, d.moveTo(f - r, g - o), d.lineTo(f + r, g + o), d.moveTo(f - r, g + o), d.lineTo(f + r, g - o), d.closePath();
                                        break;
                                    case"line":
                                        d.beginPath(), d.moveTo(f - h, g), d.lineTo(f + h, g), d.closePath();
                                        break;
                                    case"dash":
                                        d.beginPath(), d.moveTo(f, g), d.lineTo(f + h, g), d.closePath()
                                }
                                d.stroke()
                            }
                        }
            ...
            e.exports = function (t) {
                ...
                e.elements.rectangle = {
                    ...
                    draw: function () {
                        ...
                        var e = this._chart.ctx, n = this._view, i = n.width / 2, a = n.x - i, r = n.x + i, o = n.base - (n.base - n.y), s = n.borderWidth / 2;
                        n.borderWidth && (a += s, r -= s, o += s), e.beginPath(), e.fillStyle = n.backgroundColor, e.strokeStyle = n.borderColor, e.lineWidth = n.borderWidth;
                        var l = [[a, n.base], [a, o], [r, o], [r, n.base]], u = ["bottom", "left", "top", "right"], d = u.indexOf(n.borderSkipped, 0);
                        -1 === d && (d = 0), e.moveTo.apply(e, t(0));
                        for (var c = 1; 4 > c; c++)e.lineTo.apply(e, t(c));
                        e.fill(), n.borderWidth && e.stroke()
                    }, height: function () {
            ...
            e.exports = function (t) {
                var e = t.helpers, n = {position: "bottom"}, i = t.Scale.extend({
                    determineDataLimits: function () {
                        ...
                        if (a.isHorizontal()) {
                            var o = a.width - (a.paddingLeft + a.paddingRight), s = o / r, l = s * (e - a.minIndex) + a.paddingLeft;
                            return a.options.gridLines.offsetGridLines && i && (l += s / 2), a.left + Math.round(l)
                        }
                        var u = a.height - (a.paddingTop + a.paddingBottom), d = u / r, c = d * (e - a.minIndex) + a.paddingTop;
                        return a.options.gridLines.offsetGridLines && i && (c += d / 2), a.top + Math.round(c)
                    }, getPixelForTick: function (t, e) {
                        return this.getPixelForValue(this.ticks[t], t + this.minIndex, null, e)
                    }, getValueForPixel: function (t) {
                        var e, n = this, i = Math.max(n.ticks.length - (n.options.gridLines.offsetGridLines ? 0 : 1), 1), a = n.isHorizontal(), r = a ? n.width - (n.paddingLeft + n.paddingRight) : n.height - (n.paddingTop + n.paddingBottom), o = r / i;
            ...
            e.exports = function (t) {
                var e = t.helpers, n = {
                    ...
                    determineDataLimits: function () {
                        ...
                        var n = this, i = n.options, a = (i.ticks, n.chart), r = a.data, o = r.datasets, s = n.isHorizontal();
                        ...
                        var a, r, o = this, s = o.paddingLeft, l = o.paddingBottom, u = o.start, d = +o.getRightValue(t), c = o.end - u;
                        ...
                        var e = this, n = e.isHorizontal(), i = e.paddingLeft, a = e.paddingBottom, r = n ? e.width - (i + e.paddingRight) : e.height - (e.paddingTop + a), o = (n ? t - e.left - i : e.bottom - a - t) / r;
            ...
            e.exports = function (t) {
                ...
                t.LinearScaleBase = t.Scale.extend({
                    handleTickRangeOptions: function () {
                        ...
                        var t = this, n = t.options, i = n.ticks, a = e.getValueOrDefault, r = (t.isHorizontal(), t.ticks = []), o = t.getTickLimit();
                        o = Math.max(2, o);
                        var s, l = i.fixedStepSize && i.fixedStepSize > 0 || i.stepSize && i.stepSize > 0;
                        if (l)s = a(i.fixedStepSize, i.stepSize); else {
                            var u = e.niceNum(t.max - t.min, !1);
                            s = e.niceNum(u / (o - 1), !0)
                        }
                        var d = Math.floor(t.min / s) * s, c = Math.ceil(t.max / s) * s, h = (c - d) / s;
            ...
            e.exports = function (t) {
                var e = t.helpers, n = {
                    ...
                    determineDataLimits: function () {
                        ...
                        var n = this, i = n.options, a = i.ticks, r = n.chart, o = r.data, s = o.datasets, l = e.getValueOrDefault, u = n.isHorizontal();
                        if (n.min = null, n.max = null, i.stacked) {
                            var d = {};
                            e.each(s, function (a, o) {
                                ...
                                r.isDatasetVisible(o) && t(s) && (void 0 === d[s.type] && (d[s.type] = []), e.each(a.data, function (t, e) {
                                    var a = d[s.type], r = +n.getRightValue(t);
                        ...
                        for (var t = this, n = t.options, i = n.ticks, a = e.getValueOrDefault, r = t.ticks = [], o = a(i.min, Math.pow(10, Math.floor(e.log10(t.min)))); o < t.max;) {
                            r.push(o);
                            var s = Math.floor(e.log10(o)), l = Math.floor(o / Math.pow(10, s)) + 1;
                        ...
                        var r, o, s = this, l = s.start, u = +s.getRightValue(t), d = e.log10(s.end) - e.log10(l), c = s.paddingTop, h = s.paddingBottom, f = s.paddingLeft;
            ...
            e.exports = function (t) {
                var e = t.helpers, n = t.defaults.global, i = {
                    ...
                    getValueCount: function () {
                        ...
                        var r = e.min([t.height, t.width]), o = e.getValueOrDefault(a.fontSize, n.defaultFontSize);
                        ...
                        var t, i, a, r, o, s, l, u, d, c, h, f, g = this.options.pointLabels, p = e.getValueOrDefault(g.fontSize, n.defaultFontSize), m = e.getValueOrDefault(g.fontStyle, n.defaultFontStyle), v = e.getValueOrDefault(g.fontFamily, n.defaultFontFamily), b = e.fontString(p, m, v), y = e.min([this.height / 2 - p - 5, this.width / 2]), x = this.width, k = 0;
                        ...
                        var t = this, i = t.options, a = i.gridLines, r = i.ticks, o = i.angleLines, s = i.pointLabels, l = e.getValueOrDefault;
                        if (i.display) {
                            var u = t.ctx, d = l(r.fontSize, n.defaultFontSize), c = l(r.fontStyle, n.defaultFontStyle), h = l(r.fontFamily, n.defaultFontFamily), f = e.fontString(d, c, h);
                            if (e.each(t.ticks, function (o, s) {
                                    if (s > 0 || i.reverse) {
                                        var c = t.getDistanceFromCenterForValue(t.ticksAsNumbers[s]), h = t.yCenter - c;
                                        if (a.display && 0 !== s)if (u.strokeStyle = e.getValueAtIndexOrDefault(a.color, s - 1), u.lineWidth = e.getValueAtIndexOrDefault(a.lineWidth, s - 1), i.lineArc)u.beginPath(), u.arc(t.xCenter, t.yCenter, c, 0, 2 * Math.PI), u.closePath(), u.stroke(); else {
                                            u.beginPath();
                                ...
                                for (var g = t.getDistanceFromCenterForValue(i.reverse ? t.min : t.max), p = l(s.fontSize, n.defaultFontSize), m = l(s.fontStyle, n.defaultFontStyle), v = l(s.fontFamily, n.defaultFontFamily), b = e.fontString(p, m, v), y = t.getValueCount() - 1; y >= 0; y--) {
                                    ...
                                    var k = t.getPointPosition(y, g + 5), _ = l(s.fontColor, n.defaultFontColor);
                                    u.font = b, u.fillStyle = _;
                                    var w = t.pointLabels, S = w.length, M = w.length / 2, D = M / 2, C = D > y || y > S - D, T = y === D || y === S - D;
            ...
            i = "function" == typeof i ? i : window.moment, e.exports = function (t) {
                var e = t.helpers, n = {
                    ...
                    initialize: function () {
                        ...
                        var a = this;
                        a.ctx.save();
                        var r = e.getValueOrDefault(a.options.ticks.fontSize, t.defaults.global.defaultFontSize), o = e.getValueOrDefault(a.options.ticks.fontStyle, t.defaults.global.defaultFontStyle), s = e.getValueOrDefault(a.options.ticks.fontFamily, t.defaults.global.defaultFontFamily), l = e.fontString(r, o, s);
                        if (a.ctx.font = l, a.ticks = [], a.unitScale = 1, a.scaleSizeInUnits = 0, a.options.time.unit)a.tickUnit = a.options.time.unit || "day", a.displayFormat = a.options.time.displayFormats[a.tickUnit], a.scaleSizeInUnits = a.lastTick.diff(a.firstTick, a.tickUnit, !0), a.unitScale = e.getValueOrDefault(a.options.time.unitStepSize, 1); else {
                            var u = a.isHorizontal() ? a.width - (a.paddingLeft + a.paddingRight) : a.height - (a.paddingTop + a.paddingBottom), d = a.tickFormatFunction(a.firstTick, 0, []), c = a.ctx.measureText(d).width, h = Math.cos(e.toRadians(a.options.ticks.maxRotation)), f = Math.sin(e.toRadians(a.options.ticks.maxRotation));
                            c = c * h + r * f;
                            var g = u / c;
                            ...
                            for (var p = 0, m = n.units[p]; p < n.units.length;) {
                                if (a.unitScale = 1, e.isArray(m.steps) && Math.ceil(a.scaleSizeInUnits / g) < e.max(m.steps)) {
                                    for (var v = 0; v < m.steps.length; ++v)if (m.steps[v] >= Math.ceil(a.scaleSizeInUnits / g)) {
                                ...
                                var b = a.firstTick.diff(a.getMomentStartOf(a.firstTick), a.tickUnit, !0), y = a.getMomentStartOf(a.lastTick.clone().add(1, a.tickUnit)).diff(a.lastTick, a.tickUnit, !0);
                        ...
                        var a = t.format(this.displayFormat), r = this.options.ticks, o = e.getValueOrDefault(r.callback, r.userCallback);
                        return o ? o(a, n, i) : a
                    }, convertTicksToLabels: function () {
                        var t = this;
                        t.tickMoments = t.ticks, t.ticks = t.ticks.map(t.tickFormatFunction, t)
                    }, getPixelForValue: function (t, e, n, i) {
                        var a = this, r = t && t.isValid && t.isValid() ? t : a.getLabelMoment(n, e);
                        if (r) {
                            var o = r.diff(a.firstTick, a.tickUnit, !0), s = o / a.scaleSizeInUnits;
                            if (a.isHorizontal()) {
                                var l = a.width - (a.paddingLeft + a.paddingRight), u = (l / Math.max(a.ticks.length - 1, 1), l * s + a.paddingLeft);
                                return a.left + Math.round(u)
                            }
                            var d = a.height - (a.paddingTop + a.paddingBottom), c = (d / Math.max(a.ticks.length - 1, 1), d * s + a.paddingTop);
                            return a.top + Math.round(c)
                        }
                    }, getPixelForTick: function (t, e) {
                        return this.getPixelForValue(this.tickMoments[t], null, null, e)
                    }, getValueForPixel: function (t) {
                        var e = this, n = e.isHorizontal() ? e.width - (e.paddingLeft + e.paddingRight) : e.height - (e.paddingTop + e.paddingBottom), a = (t - (e.isHorizontal() ? e.left + e.paddingLeft : e.top + e.paddingTop)) / n;
